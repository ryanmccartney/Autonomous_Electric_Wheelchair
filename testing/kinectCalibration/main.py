...
#DESC: Main python script for the calibration of a kinect sensor.
...
#Create a file for logging the results
try:
    #open a txt file to duse for logging 
    logFile = open("testing/kinectCalibration/results.txt","w+")
...
try: 
    ...
    kinectImage = cameraData(test_url,"Kinect RGB Data")
